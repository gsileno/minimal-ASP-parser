// ASP grammar
// ===================
// This is a subset of the Answer Set Programming syntax used for clingo

// Note: This grammar is minimal, and does not force certain syntaxic constraints, namely:
// - literals used for facts should be grounded (no variables)
...
/** The overall program consists of facts and rules. */
program : ( aspfact | asprule)* EOF ;
